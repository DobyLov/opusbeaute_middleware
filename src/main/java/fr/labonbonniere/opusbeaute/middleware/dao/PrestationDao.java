...
//		List<Prestation> listePrestations;
	...
	public Prestation obtenirPrestation(final Integer idPrestation) throws PrestationInexistanteException {
			...
			if (Objects.isNull(prestation)) {
				...
				throw new PrestationInexistanteException ("PrestationsDao Exception : L' Id : " + idPrestation + " est introuvable dans la base");
			}
			
			logger.info("PrestationsDao log : Prestations " + idPrestation + " trouve, envoie de l objet Prestations a PrestationsService");
			return prestation;			
	...
	public List<Prestation> obtenirListPrestationsCriteresGenreActivite(String genre, String activite ) throws DaoException {
		...
		try {
			...
			logger.info("PrestationsDao log : Transmission de la Liste des Prestations selon les criteres GenreActivieSoin.");
			return prestationGA;
	...
	public List<Prestation> obtenirListPrestationsCriteresGenreActiviteSoins(String genre, String activite, String soin ) throws DaoException {
	...
	public void ajouterUnePrestation (Prestation prestation)  throws PrestationExistanteException {
		...
		try {
			...
			throw new PrestationExistanteException("PrestationsDao Exception : Probleme, cette Prestations a l air d'être deja persistee");
	 ...
	 public void modifieUnePrestation(Prestation prestation) throws PrestationInexistanteException {
			...
			logger.info("PrestationsDao log : Demande de modification de la prestation id : " + prestation.getIdPrestation() + " a la Bdd.");
			Prestation prestationbdd = em.find(Prestation.class, prestation.getIdPrestation());		
			if ( Objects.nonNull(prestationbdd) ) {
				em.merge(prestation);			
				logger.info("PrestationsDao log : Rdv id : " + prestation.getIdPrestation() + " a ete modifie dans la Bdd.");
			} else {
				logger.error("PrestationsDao log : Rdv id : " + prestation.getIdPrestation() + " ne peut etre modifie de la Bdd.");
				throw new PrestationInexistanteException("PrestationsDao log : Modification impossible," 				
						...
						+ prestation.getIdPrestation() + " demande.");
			}			
	}
	...
	public void supprimeUnePrestation(final Integer idPrestation ) throws PrestationInexistanteException {
		...
		logger.info("PrestationsDao log : Demande de suppression de la Prestation id : " + idPrestation + " a la Bdd.");
			...
			logger.info("PrestationsDao log : Prestation id : " + idPrestation + " a bien ete supprime de la Bdd.");
				...
				logger.error("PrestationsDao log : Prestation id : " + idPrestation + " inexistant alors il ne peut etre supprime de la Bdd.");
				throw new PrestationInexistanteException("PrestationsDao Exception : Prestation id : " + idPrestation + " ne peut etre supprime de la Bdd.");
			}
	}
