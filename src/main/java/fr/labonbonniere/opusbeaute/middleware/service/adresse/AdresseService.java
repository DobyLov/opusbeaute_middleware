...
public class AdresseService {
	...
	public void ajoutAdresse(Adresse adresse) throws AdresseExistanteException, NbNumRueException, NbCharRueVilleException, NbNumZipcodeException, NbCharPaysException {
	...
	public void modifDeLAdresse(Adresse adresse) throws AdresseInexistanteException, NbNumRueException, NbCharRueVilleException, NbNumZipcodeException, NbCharPaysException {
	...
	private Adresse adresseValiderFormater(Adresse adresse)
		...
		if (adresse.getNumero() != null && !adresse.getNumero().isEmpty()) {
			...
			if (adresse.getNumero().length() > 3) {
				...
				adresseFormatee.setNumero(adresse.getNumero());
			}
		} else {
		...
		if (adresse.getRue() != null && !adresse.getRue().isEmpty()) {
			if (adresse.getRue().length() > 30) {
				...
				adresseFormatee.setRue(WordUtils.capitalizeFully(adresse.getRue()));
			}
		} else {
		...
		if (adresse.getVille() != null && !adresse.getVille().isEmpty()) {
			if (adresse.getVille().length() > 30) {
				...
				adresseFormatee.setVille(adresse.getVille().toUpperCase());
			}
		} else {
			throw new NbCharRueVilleException(
		...
		if (adresse.getPays() != null && !adresse.getPays().isEmpty()) {
			if (adresse.getPays().length() > 6) {
				...
				adresseFormatee.setPays(adresse.getPays().toUpperCase());
			}
		} else {
