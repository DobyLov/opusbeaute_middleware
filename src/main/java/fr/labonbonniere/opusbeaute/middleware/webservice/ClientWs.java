...
public class ClientWs {
		...
		public Response creerUnClient(Client client) throws ClientExistantException {
		...
		@Produces(MediaType.APPLICATION_JSON)
		@Consumes(MediaType.APPLICATION_JSON)
		public Response modifieUnClient(Client client) throws ClientInexistantException {

			Response.ResponseBuilder builder = null;
			try {
				logger.info("-----------------------------------------------------");
				logger.info("ClientWs log : Demande de modification du Client id : " + client.getIdClient()
						+ " dans la Bdd.");
		...
		@Produces(MediaType.APPLICATION_JSON)
		@Consumes(MediaType.APPLICATION_JSON)
		public Response deleteTheClient(@PathParam("idClient") final Integer idClient)
			...
			try {
				...
				String msg = "ClientWs log : Client id : " + idClient + " a ien ete supprime de la Bdd.";
				builder = Response.ok(msg);
