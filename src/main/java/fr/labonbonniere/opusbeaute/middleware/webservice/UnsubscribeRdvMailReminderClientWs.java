...
public class UnsubscribeRdvMailReminderClientWs {

	private static final Logger logger = LogManager.getLogger(UnsubscribeRdvMailReminderClientWs.class.getName());
